(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.vueInternetChecker = factory());
  ...
  function normalizeScopedSlot(normalSlots, key, fn) {
    var normalized = function normalized() {
      ...
      res = res && _typeof(res) === 'object' && !Array.isArray(res) ? [res] : normalizeChildren(res);
  ...
  var dist = createCommonjsModule(function (module, exports) {
    (function webpackUniversalModuleDefinition(root, factory) {
      ...
      return function (modules) {
        ...
        var Notify = {
          install: function install(Vue) {
            ...
            var notify = function notify(params) {
              ...
              if ((typeof params === 'undefined' ? 'undefined' : _typeof$1(params)) === 'object') {
                __WEBPACK_IMPORTED_MODULE_1__events__["a"].$emit('add', params);
              }
            };

            notify.close = function (id) {
              __WEBPACK_IMPORTED_MODULE_1__events__["a"].$emit('close', id);
            };
        ...
        var Component = __webpack_require__(0)(__webpack_require__(5), __webpack_require__(15), null, null);
        ...
        var Component = {
          ...
          props: {
            ...
            position: {
              ...
              "default": function _default() {
                return __WEBPACK_IMPORTED_MODULE_3__defaults__["a"].position;
              }
            },
            classes: {
              type: String,
            ...
            animation: {
              type: Object,
              "default": function _default() {
                return __WEBPACK_IMPORTED_MODULE_3__defaults__["a"].velocityAnimation;
              }
            },
            animationName: {
              type: String,
              "default": __WEBPACK_IMPORTED_MODULE_3__defaults__["a"].cssAnimation
            },
            speed: {
              type: Number,
              "default": 300
          ...
          mounted: function mounted() {
            __WEBPACK_IMPORTED_MODULE_1__events__["a"].$on('add', this.addItem);

            __WEBPACK_IMPORTED_MODULE_1__events__["a"].$on('close', this.closeItem);
          },
          computed: {
            actualWidth: function actualWidth() {
              return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__parser__["a"])(this.width);
            },
            isVA: function isVA() {
            ...
            styles: function styles() {
              var _listToDirection = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__util__["a"])(this.position),
          ...
          methods: {
            ...
            addItem: function addItem(event) {
              ...
              var title = event.title,
                  ...
                  id = event.id;
              var item = {
                id: id || __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__util__["b"])(),
                title: title,
                text: text,
                type: type,
                state: STATE.IDLE,
        ...
        var Component = __webpack_require__(0)(__webpack_require__(4), __webpack_require__(16), null, null);
